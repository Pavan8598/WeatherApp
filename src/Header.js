...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <Grid item xs={3}>
        <div>
          <Button onClick={handleOpen} style={{ backgroundColor: "purple", color: 'white', height: '40px', width: '140px', marginTop: '20px', marginLeft: '390px' }}>Add New City</Button>
          ...
          >
            {/* <Box sx={{
              ...
              <div>
                <Grid container spacing={0}>
                  <Grid item xs={8}>
                    <h3 style={{ marginTop: 10, marginLeft: 10 }} >Add City Modal</h3>
                  </Grid>
                  <Grid item xs={4}>
                    <CloseIcon onClick={handleClose} style={{ marginLeft: 90, marginTop: 10 }}></CloseIcon>
                  </Grid>
                </Grid>
              </div>
              <Divider />
              <Row>
                <TextField id="outlined-basic" label='Search City' variant="outlined" size='small' style={{ align: 'centre', marginLeft: 100 }} />
              </Row>
            ...
            {/* {user.map((data) => (
                  ...
                  <div style={{ display: 'flex' }}>
                    ...
                    <AddCircleOutlineIcon   style={{ marginTop: 10 , marginRight: 10 }}></AddCircleOutlineIcon>
            ...
            <Card sx={{
              minWidth: 70, width: 250, width: 400,
              marginTop: 28,
              marginLeft: 75,
            }}>
              <CardContent>
